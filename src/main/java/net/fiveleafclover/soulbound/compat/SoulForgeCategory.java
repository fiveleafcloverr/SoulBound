...
public class SoulForgeCategory implements DisplayCategory<BasicDisplay> {
    ...
    public static final Identifier TEXTURE =
            new Identifier(SoulBound.MOD_ID, "textures/gui/soul_forge_gui.png");
    public static final CategoryIdentifier<SoulForgeDisplay> SOUL_FORGE =
            CategoryIdentifier.of(SoulBound.MOD_ID, "soul_forging");
    ...
    public Text getTitle() {
        return Text.translatable("rei.soulbound.soul_forge");
    }
